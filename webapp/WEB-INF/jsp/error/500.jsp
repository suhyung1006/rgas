...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/pages/page-500.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
                ...
                <div class="section p-0 m-0 height-100vh section-500">
                    <div class="row">
                        ...
                        <div class="col s12 center-align white">
                            <img src="/images/gallery/error-2.png" alt="" class="bg-image-500">
                            <h1 class="error-code m-0">500</h1>
                            <h6 class="mb-2">잘못된 요청입니다.</h6>
                            <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="/home">
                            홈 화면으로 돌아가기</a>
                        </div>
                    </div>
                </div>
